...
const WorkspaceSettings = ({ setScreen }) => {
        ...
        <div style={containerStyle}>
          ...
          <div style={rowStyle}>
            <div style={{ fontSize: "14px" }}>
              <span style={{ color: "#ae2e24", fontWeight: "bold" }}>
                🔒 Private
              </span>{" "}
          ...
          <div style={premiumBoxStyle}>
            ...
            <div style={disabledRowStyle}>
              <div>
                ...
                <div style={{ fontSize: "13px" }}>
                  Any Workspace member can create public, workspace visible, and
                  private boards.
                </div>
              </div>
              <button
            ...
            <div style={disabledRowStyle}>
              <div>
                ...
                <div style={{ fontSize: "13px" }}>
                  Any Workspace member can delete public, workspace visible, and
                  private boards.
                </div>
              </div>
              <button
